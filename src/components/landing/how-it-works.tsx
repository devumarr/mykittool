    ...
    <section className="w-full py-24 sm:py-32 bg-background relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-24 space-y-4 animate-reveal">
          ...
          <p className="text-[9px] text-foreground/50 font-black uppercase tracking-[0.3em]">Three step logic</p>
        </div>
            ...
            <div key={index} className="flex flex-col items-center text-center group animate-reveal" style={{ animationDelay: `${index * 150}ms` }}>
              <div className={cn(
                ...
                <div className="space-y-3 relative z-10">
                  <h3 className="text-xs font-black text-foreground uppercase tracking-[0.3em]">{step.title}</h3>
                  <p className="text-[10px] text-foreground/50 font-medium leading-relaxed uppercase tracking-tighter max-w-[200px] mx-auto">{step.description}</p>
                </div>
              </div>
            </div>
          ))}
