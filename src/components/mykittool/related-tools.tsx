...
const TOOL_DETAILS: Record<string, { title: string; desc: string; icon: any }> =
  {
    "/pdf-splitter": {
      title: "PDF Splitter",
      desc: "Extract pages from documents.",
      icon: Scissors,
    },
    "/pdf-compressor": {
      title: "PDF Compressor",
      desc: "Reduce PDF file size locally.",
      icon: Archive,
    },
    "/image-to-pdf": {
      title: "Image to PDF",
      desc: "Convert photos into a PDF master.",
      icon: FileDown,
    },
    "/pdf-merger": {
      title: "PDF Merger",
    ...
    "/ai-chatbot": {
      title: "AI Chatbot",
      desc: "Fast linguistic synthesis assistant.",
      icon: MessageSquare,
    },
    "/ai-email-writer": {
    ...
    "/ai-code-generator": {
      title: "AI Code Gen",
      desc: "Synthesize code from requests.",
      icon: Code2,
    },
    "/ai-resume-builder": {
      title: "AI Resume",
      desc: "Create high-fidelity resumes.",
      icon: User,
    },
    "/ai-campaign-planner": {
      title: "AI Campaign",
      desc: "Strategy and niche discovery.",
      icon: Zap,
    },
    "/ai-image-generator": {
      title: "AI Image Gen",
    ...
    "/background-remove": {
      title: "BG Remove",
      desc: "Isolate subjects from photos.",
      icon: Eraser,
    },
    "/logo-maker": {
      title: "Logo Maker",
      desc: "Design premium text-based logos.",
      icon: Type,
    },
    "/image-to-link": {
      title: "Image to Link",
      desc: "Anonymous high-res hosting.",
      icon: Globe,
    },
    "/text-to-speech": {
      title: "Text to Speech",
      desc: "Convert text to natural audio.",
      icon: Volume2,
    },
    "/speech-to-text": {
      title: "Speech to Text",
      desc: "Real-time voice transcription.",
      icon: Mic,
    },
    "/voice-changer": {
      title: "Voice Changer",
      desc: "Live acoustic modulation.",
      icon: Mic2,
    },
    "/vocal-separator": {
      title: "Vocal Remover",
      desc: "Reduce vocals from tracks.",
      icon: Music,
    },
    "/audio-booster": {
      title: "Volume Booster",
      desc: "Amplify audio levels safely.",
      icon: Volume2,
    },
    "/image-resizer": {
      title: "Image Resizer",
      desc: "Scale pixel dimensions.",
      icon: Maximize,
    },
    "/image-compressor": {
      title: "Image Compressor",
      desc: "Optimize imagery locally.",
      icon: Minimize2,
    },
    "/image-to-webp": {
      title: "Image to WebP",
      desc: "Convert to next-gen formats.",
      icon: FileImage,
    },
    "/photo-editor": {
      title: "Photo Studio",
      desc: "Professional local editing.",
      icon: Palette,
    },
    "/bulk": {
      title: "Bulk QR",
      desc: "Batch production engine.",
      icon: Layers,
    },
    "/single": {
      title: "Single Studio",
    ...
    "/all-tools": {
      title: "The ToolBox",
      desc: "Complete studio registry.",
      icon: LayoutGrid,
    },
    "/quran-ayah": {
      title: "Quran Ayah",
      desc: "Explore the Quranic matrix.",
      icon: BookOpen,
    },
    "/holidays": {
      title: "Holidays",
      desc: "Global public holiday matrix.",
      icon: Calendar,
    },
    "/ip-finder": {
      title: "IP Finder",
      desc: "Isolate network identities.",
      icon: Smartphone,
    },
    "/dns-lookup": {
      title: "DNS Lookup",
      desc: "Clinical DNS auditing.",
      icon: Globe,
    },
    "/website-trust-checker": {
      title: "Trust Checker",
      desc: "Domain security diagnostics.",
      icon: Shield,
    },
    "/speed-test": {
      title: "Speed Test",
      desc: "Network pulse telemetry.",
      icon: Zap,
    },
    "/password-generator": {
      title: "Password Gen",
      desc: "Secure entropy generation.",
      icon: Lock,
    },
    "/password-breach-checker": {
      title: "Breach Checker",
      desc: "Verify identity exposure.",
      icon: ShieldAlert,
    },
    "/hash-generator": {
      title: "Hash Generator",
      desc: "Binary fingerprinting.",
      icon: Fingerprint,
    },
    "/uuid-generator": {
    ...
    "/file-compressor": {
      ...
      desc: "Browser-side size reduction.",
      icon: FileArchive,
    },
    "/markdown-preview": {
      title: "MD Preview",
      desc: "Real-time markup synthesis.",
      icon: FileEdit,
    },
    "/code-preview": {
      title: "Code Preview",
      desc: "Sandboxed dev environment.",
      icon: Monitor,
    },
  };
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col items-center text-center gap-4 mb-16">
          <h2 className="text-2xl md:text-4xl font-headline font-black text-foreground uppercase tracking-tight leading-none">
            You might also{" "}
            <span className="text-primary italic">like these tools</span>
          </h2>
          <p className="text-[10px] font-black text-foreground/20 uppercase tracking-[0.4em]">
            Extended Studio Capabilities
          </p>
        </div>
              ...
              <div className="h-full p-8 rounded-[2.5rem] bg-white/[0.01] border border-white/5 transition-all duration-500 hover:bg-white/[0.03] hover:border-primary/20 hover:-translate-y-1 shadow-2xl relative overflow-hidden flex flex-col justify-between">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-base font-headline font-black text-foreground uppercase tracking-tight group-hover:text-primary transition-colors leading-tight">
                      {tool.title}
                    </h3>
                    <p className="text-[11px] text-foreground/40 font-medium leading-relaxed uppercase tracking-tighter line-clamp-2">
                      {tool.desc}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-4 border-t border-white/5 flex items-center justify-between relative z-10">
                  <span className="text-[8px] font-black text-foreground/10 group-hover:text-primary/40 uppercase tracking-[0.3em] transition-colors">
                    Initialize
                  </span>
