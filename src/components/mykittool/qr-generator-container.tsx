    ...
    <div className="space-y-12">
      {!forcedMode && (
        <div className="flex justify-center mb-12">
          <div className="w-full max-w-md bg-white/50 dark:bg-background/50 border border-white/20 dark:border-white/10 p-1.5 h-16 rounded-[2rem] flex backdrop-blur-xl animate-reveal">
            <button
              ...
              className={cn(
                ...
                activeMode === "single"
                  ? "bg-primary text-primary-foreground shadow-2xl scale-100"
                  : "text-foreground/40 hover:text-foreground scale-95 opacity-70",
              )}
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        <div className="lg:col-span-7 xl:col-span-8 space-y-10">
          {activeMode === "single" ? (
            <div
              key="single-form"
              className="animate-in fade-in slide-in-from-top-6 duration-700"
            >
