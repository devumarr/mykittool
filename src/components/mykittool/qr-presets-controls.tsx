        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
          {TEMPLATES.map((t) => (
            <button
              ...
              className="flex flex-col items-center gap-4 p-5 rounded-[2rem] bg-white/30 dark:bg-background/30 border border-white/10 hover:border-primary/40 hover:bg-primary/5 transition-all group shadow-sm"
            >
              <div className="w-12 h-12 rounded-2xl bg-white dark:bg-background/50 flex items-center justify-center transition-all group-hover:scale-110 group-hover:rotate-6 border border-white/10 shadow-lg text-primary">
                {t.id === "image-qr" ? (
