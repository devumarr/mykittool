...
export default function WordCounterPage() {
  ...
  const handleCopy = () => {
    if (text) {
      ...
      toast({
        ...
        description: "Text matrix saved to clipboard.",
      });
  ...
  const handleClear = () => {
    ...
    toast({
      title: "Studio Reset",
      description: "All linguistic data cleared.",
    });
  };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
          Professional linguistic analysis matrix. Calculate density, character
          volume, and precise reading/speaking time estimates entirely in your
          browser.
        </p>
      </div>
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5 group-hover:bg-primary/10 transition-colors">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Our analysis engine operates entirely within your browser
                session. Your text data is never uploaded or transmitted to any
                server.
              </p>
            </div>
          </div>
            ...
            <CardContent className="pt-10 space-y-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="p-6 rounded-[2rem] bg-secondary border border-border group/stat hover:border-primary/40 transition-all text-center space-y-2"
                  >
              ...
              <div className="p-8 rounded-[2.5rem] bg-primary/5 border border-primary/10 space-y-8 relative overflow-hidden group/time shadow-inner">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white dark:bg-background flex items-center justify-center text-primary shadow-lg border border-primary/20">
                ...
                <p className="text-[9px] text-foreground/40 text-center leading-relaxed font-medium pt-2 border-t border-primary/10">
                  Calculated using standard 200 WPM reading and 130 WPM speaking
                  protocols.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-secondary border border-border flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                    Linguistic matrix rounding applied to nearest integer for
