...
export default function DuplicateLineRemoverPage() {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        toast({
          ...
          description: "Text file loaded into studio.",
        });
      };
  ...
  const handleCopy = () => {
    if (output) {
      ...
      setIsCopied(true);
      toast({
        title: "Cleaned Matrix Copied",
        description: "Result saved to clipboard.",
      });
  ...
  const handleDownload = () => {
    ...
    toast({
      ...
      description: "Linguistic master saved as .txt",
    });
  };
  ...
  const handleClear = () => {
    ...
    toast({
      title: "Studio Reset",
      description: "Input and output buffers cleared.",
    });
  };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl leading-relaxed">
          Professional redundancy sanitization. Identify and purge duplicate
          entries from logs, lists, and data blocks with precision comparison
          protocols.
        </p>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/50 border border-border group/toggle hover:border-primary/20 transition-all">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[8px] text-foreground/20 font-bold uppercase tracking-tighter">
                        Case-Insensitive
                      </p>
                    </div>
                    <Switch
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                The engine utilizes a "Keep First" protocol. The initial
                encounter of a unique character string is preserved in its
                original formatting, while all subsequent matching matrices are
                definitively purged.
              </p>
            </div>
          </div>
        ...
        <div className="lg:col-span-5 space-y-8 animate-in fade-in slide-in-from-right-6 duration-1000 stagger-2">
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative group">
            ...
            <CardContent className="pt-10 space-y-8">
              ...
              <div className="relative group/output rounded-[2rem] bg-white dark:bg-background border border-border overflow-hidden shadow-inner">
                <div className="p-3 bg-secondary/50 border-b border-border flex items-center justify-between">
                  ...
                  <span className="text-[9px] font-mono text-primary font-bold">
                    {stats.final.toLocaleString()} Lines Remaining
                  </span>
                </div>
                <pre className="w-full min-h-[300px] max-h-[500px] p-8 font-mono text-[11px] leading-relaxed focus:outline-none bg-transparent text-foreground custom-scrollbar overflow-auto whitespace-pre">
                  {output || (
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group transition-all hover:bg-secondary/80">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                      Unique character strings are indexed via a
                      high-performance hash map for instant identification.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group transition-all hover:bg-secondary/80">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                      Linear split-join protocols allow for high-volume text
                      processing with minimal hardware latency.
                    </p>
                  </div>
                </div>
              </div>
