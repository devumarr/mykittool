...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="container mx-auto px-6 py-20 max-w-4xl">
      ...
      <div className="glass-card p-12 rounded-[3.5rem] border-border animate-reveal stagger-3 text-center relative overflow-hidden bg-background">
        ...
        <p className="text-sm text-foreground/40 font-medium mb-10 max-w-xl mx-auto uppercase tracking-widest relative z-10">
          Providing professional-grade utilities with a focus on local privacy
          and user autonomy.
        </p>
        <Button
          asChild
