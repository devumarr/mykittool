  ...
  const sections = [
    {
      ...
      content:
        "We use 'Local Storage' to remember your studio preferences, such as your selected brand colors, active tool styles, and theme settings. This allows you to resume your design work across sessions.",
    },
    {
      icon: Database,
      title: "Functional Cookies",
      content:
        "We utilize minimal functional cookies to manage security sessions and ensure our AI integrations (Imagen/Gemini) function correctly within your browser context.",
    },
    {
      icon: Info,
      title: "How to Manage",
  ...
  return (
    <div className="container mx-auto px-6 py-20 max-w-4xl">
      ...
      <div className="glass-card p-10 rounded-[3rem] border-border animate-reveal stagger-3 text-center">
        <h2 className="text-2xl font-headline font-black text-foreground uppercase tracking-tight mb-6">
          Zero Tracking Guarantee
        </h2>
        <p className="text-sm text-foreground/50 leading-relaxed font-medium max-w-xl mx-auto">
          Unlike other utility suites, MY KIT TOOL does not use third-party
          advertising cookies that follow you across the web. Your studio
          activity is private and localized.
        </p>
      </div>
    </div>
  );
