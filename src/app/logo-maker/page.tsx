...
export default function LogoMakerPage() {
  ...
  const renderLogo = useCallback(() => {
    ...
    if (layoutMode === "text-only") {
      ...
      groupHeight =
        ...
        iconGap +
        nameHeight +
        (tagUpper ? taglineGap + tagHeight : 0);
    } else if (layoutMode === "icon-left" || layoutMode === "icon-right") {
      const textBlockHeight = tagUpper
        ? nameHeight + taglineGap + tagHeight
        : nameHeight;
    ...
    let finalScale = 1;
    if (groupWidth > maxContentWidth)
      finalScale = Math.min(finalScale, maxContentWidth / groupWidth);
    if (groupHeight > maxContentWidth)
      finalScale = Math.min(finalScale, maxContentWidth / groupHeight);
    ...
    // Drawing
    if (layoutMode === "text-only") {
      const startY = tagUpper
        ? -(nameHeight + taglineGap + tagHeight) / 2 + nameHeight
        : 0;
      ...
      if (layoutMode === "icon-left") {
        ...
        const textStartY = tagUpper
          ? -textBlockHeight / 2 + nameHeight
          : nameHeight / 2;
  ...
  const applyPreset = (p: any) => {
    ...
    toast({
      title: "Preset Loaded",
      description: `${p.label} profile synthesized.`,
    });
  };
  ...
  const randomize = () => {
    ...
    do {
      ...
      nextShape = [
        ...
        "square",
        "oval",
      ][Math.floor(Math.random() * 9)] as BadgeShape;
      ...
      nextLayout = [
        ...
        "badge-only",
        "text-only",
      ][Math.floor(Math.random() * 5)] as LayoutMode;
      ...
      if (!recentRandoms.current.includes(fingerprint) || attempt > 5) {
        recentRandoms.current = [
          fingerprint,
          ...recentRandoms.current.slice(0, 9),
        ];
    ...
    toast({
      ...
      description: "Unique identity matrix synthesized.",
    });
  };
  ...
  const handleDownload = () => {
    ...
    toast({
      ...
      description: `${exportSize}px PNG master exported.`,
    });
  };
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl leading-relaxed">
              Premium typographic branding architecture. Design high-impact
              identities with advanced geometry, gradients, and production-grade
              export protocols.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                ...
                <CardContent className="pt-8 space-y-10">
                  <div className="space-y-8">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => setFontIndex(parseInt(v))}
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                      ...
                      <div className="space-y-4 col-span-full">
                        ...
                        <Slider
                          ...
                          max={100}
                          step={1}
                          onValueChange={(v) => setTaglineGap(v[0])}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <Select
                        value={badgeShape}
                        onValueChange={(v: BadgeShape) => setBadgeShape(v)}
                      >
                    ...
                    <div className="grid grid-cols-2 gap-8">
                      <div className="space-y-3">
                        <p className="text-[8px] font-black text-foreground/30 uppercase">
                          Icon Scale
                        </p>
                        <Slider
                          value={[iconSize]}
                      ...
                      <div className="space-y-3">
                        ...
                        <Slider
                          ...
                          max={200}
                          step={5}
                          onValueChange={(v) => setIconGap(v[0])}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="p-4 rounded-xl bg-secondary border border-border flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[9px] font-black uppercase text-foreground/60">
                          Logotype Color
                        </span>
                      </div>
                      <div
                        className="w-8 h-8 rounded-lg relative overflow-hidden ring-1 ring-border"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      ...
                      <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/50 border border-border">
                        ...
                        <Switch
                          ...
                          onCheckedChange={setUseTextGradient}
                          className="scale-75"
                        />
                      </div>
                      <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/50 border border-border">
                        ...
                        <Switch
                          ...
                          onCheckedChange={setUseBgGradient}
                          className="scale-75"
                        />
                      </div>
                    </div>
                  ...
                  <div className="p-6 rounded-[2rem] bg-secondary border border-border space-y-6">
                    ...
                    {!isTransparent && (
                      <div className="flex items-center gap-4 animate-in fade-in">
                        <div
                          className="w-10 h-10 rounded-xl relative overflow-hidden ring-1 ring-border"
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Our rendering engine utilizes browser-side bi-linear
                interpolation and hardware-accelerated 2D context to ensure
                text-shadows and gradients retain peak fidelity in large
                exports.
              </p>
            </div>
          </div>
        ...
        <div className="lg:col-span-7 space-y-8 animate-in fade-in slide-in-from-right-6 duration-1000 stagger-2">
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative flex flex-col min-h-[600px]">
            ...
            <CardContent className="flex-1 flex flex-col items-center justify-center p-10 bg-background/5 dark:bg-background/60 relative">
              <div className="relative w-full max-w-[500px] aspect-square rounded-[3.5rem] overflow-hidden shadow-2xl ring-1 ring-white/10 group/canvas cursor-move bg-checkered">
                ...
                {isTransparent && (
                  <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 opacity-60 pointer-events-none">
                    <div className="bg-background/60 backdrop-blur-md px-4 py-2 rounded-full flex items-center gap-3 text-[10px] font-black text-white uppercase tracking-widest border border-white/10">
                ...
                <div className="p-6 rounded-[2rem] bg-secondary/50 border border-border flex items-start gap-5 group hover:border-primary/20 transition-all">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[11px] text-foreground/40 font-medium leading-relaxed">
                      Symbol vectors and containers are rendered with absolute
                      symmetry and scale-independent math.
                    </p>
                  </div>
                </div>
                <div className="p-6 rounded-[2rem] bg-secondary/50 border border-border flex items-start gap-5 group hover:border-primary/20 transition-all">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[11px] text-foreground/40 font-medium leading-relaxed">
                      Export {exportSize}px assets ready for social profile
                      grids and high-res brand documents.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="p-8 rounded-[3rem] bg-primary/5 border border-primary/10 flex items-start gap-6 group hover:bg-primary/10 transition-all duration-500">
            ...
            <div className="space-y-2">
              <h4 className="text-[13px] font-black text-primary uppercase tracking-widest">
                Identity Matrix Alpha
              </h4>
              <p className="text-[12px] text-foreground/50 leading-relaxed font-medium">
                Our rendering pipeline operates entirely in your browser memory.
                Your branding data is never transmitted or stored, ensuring your
                corporate identifiers remain strictly private and permanent.
              </p>
            </div>
          </div>
        </div>
