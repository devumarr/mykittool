...
export default function KeyboardTestPage() {
  ...
  const [historyLog, setHistoryLog] = useState<
    { code: string; label: string; time: number }[]
  >([]);
  ...
  const handleReset = () => {
    ...
    toast({
      title: "Matrix Purged",
      description: "Hardware testing buffer cleared.",
    });
  };
  ...
  return (
    <div
      ref={containerRef}
      className="container mx-auto px-4 md:px-6 py-12 md:py-20 max-w-full bg-[#0a0a0c] min-h-screen overflow-x-hidden"
    >
      <div className="mb-12 animate-reveal flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="min-w-0">
          ...
          <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl leading-relaxed">
            Professional high-fidelity integrity matrix. Verify keystroke
            fidelity, ghosting collision, and hardware signal latency locally.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 shrink-0 pb-2">
          ...
          <Button
            ...
            className={cn(
              "h-12 w-12 rounded-xl border-border bg-secondary transition-all",
              !isMuted && "text-primary border-primary/20",
            )}
          >
            {isMuted ? (
          ...
          <Button
            ...
            className="h-12 w-12 rounded-xl border-border bg-secondary"
          >
            {isFullscreen ? (
          ...
          <Button
            variant="outline"
            onClick={handleReset}
            className="h-12 px-6 rounded-xl border-border bg-secondary text-[8px] font-black uppercase tracking-widest hover:text-destructive transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
        ...
        <div className="lg:col-span-8 space-y-6 min-w-0">
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative bg-background/60 p-4 sm:p-10">
              ...
              {ROWS.map((row, rIdx) => (
                <div
                  ...
                  className={cn(
                    ...
                    rIdx === 0
                      ? "justify-start mb-4 overflow-x-auto no-scrollbar"
                      : "justify-center",
                  )}
                >
                  {row.map((code) => {
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          code.startsWith("F") &&
                            !code.startsWith("Fi") &&
                            "h-8 sm:h-10 lg:h-12 bg-white/[0.02] flex-none w-10 sm:w-14",
                          isPressed
                          ...
                          isCurrentlyActive &&
                            "scale-90 bg-primary text-white border-primary shadow-[0_0_25px_rgba(59,130,246,0.6)] z-20",
                        )}
                      >
            ...
            <div className="mt-8 flex justify-center gap-12 pt-6 border-t border-white/5">
              <div className="flex items-center gap-4">
                <div
                  className={cn(
                    ...
                    isCapsLock
                      ? "bg-primary shadow-[0_0_10px_rgba(59,130,246,1)]"
                      : "bg-white/10",
                  )}
                />
                <span
                  className={cn(
                    ...
                    isCapsLock ? "text-primary" : "text-white/20",
                  )}
                >
                  Caps Lock
                </span>
              ...
              <div className="flex items-center gap-4">
                ...
                <span
                  className={cn(
                    "text-[9px] font-black uppercase tracking-widest",
                    isNumLock ? "text-primary" : "text-white/20",
                  )}
                >
                  Num Lock
                </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-8 rounded-[3rem] bg-secondary border border-border flex items-start gap-6 group hover:bg-secondary/80 transition-all shadow-lg">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase">
                  Keystroke capture occurs strictly in local memory. Keystroke
                  registries and hardware identifiers are never transmitted,
            ...
            <div className="p-8 rounded-[3rem] bg-secondary border border-border flex items-start gap-6 group hover:bg-secondary/80 transition-all shadow-lg">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase">
                  Integrated 44.1kHz audio matrix provides audible confirmation
                  of signal reaching the browser event loop for high-speed
                  hardware testing.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-6 rounded-3xl bg-primary/5 border border-primary/20 text-center space-y-2">
                  <p className="text-3xl font-headline font-black text-primary">
                    {Math.round((pressedKeys.size / 80) * 100)}%
                  </p>
                  <p className="text-[9px] font-black uppercase text-primary/40 tracking-widest">
                    Coverage
                  </p>
                </div>
              </div>
                    ...
                    historyLog.map((h, i) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <span className="text-[10px] font-mono text-foreground/20 font-bold uppercase">
                            {h.code}
                          </span>
                        </div>
                        <span className="text-[8px] font-bold text-foreground/10">
            ...
            <CardContent className="p-8 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-foreground/40 leading-relaxed font-medium uppercase">
                    Using ANSI/ISO composite matrix. Verified for 104-key and
                    laptop profiles.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-foreground/40 leading-relaxed font-medium uppercase">
                    Direct hardware event mapping for 1:1 input speed and
                    ghosting verification.
                  </p>
                </div>
              </div>
            </CardContent>
