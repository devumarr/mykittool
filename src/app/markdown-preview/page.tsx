...
export default function MarkdownPreviewPage() {
  ...
  const handleCopy = (content: string, type: "html" | "md") => {
    ...
    toast({
      title: "Matrix Copied",
      description: `${type.toUpperCase()} content saved to clipboard.`,
    });
  };
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-12 md:py-20 max-w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
              Professional real-time Markdown synthesis. Draft high-quality
              documentation with precision GFM support and sanitized HTML
              output.
            </p>
          </div>
        ...
        <Card className="glass-card border-border shadow-2xl overflow-hidden relative group min-h-[700px] flex flex-col">
          ...
          <div className="flex-1 flex flex-col md:flex-row min-h-0">
                ...
                <div className="p-3 bg-secondary/30 border-b border-border flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="text-[10px] font-black uppercase text-primary hover:opacity-70 transition-all"
                    >
                    ...
                    <button
                      ...
                      className="text-[10px] font-black uppercase text-foreground/40 hover:text-primary transition-all"
                    >
                      Download
                    </button>
                  </div>
            ...
            {(layoutMode === "split" || layoutMode === "preview") && (
              <div className="flex-1 flex flex-col bg-white/10 dark:bg-background/10 overflow-hidden">
                <Tabs
                  value={activeTab}
                ...
                >
                  <TabsList className="h-12 w-full justify-start rounded-none bg-secondary/50 border-b border-border p-0">
                    <TabsTrigger
                      value="preview"
                      className="h-full rounded-none px-6 text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-background data-[state=active]:text-primary border-r border-border transition-all"
                    >
                      <Eye className="w-3.5 h-3.5 mr-2" /> Visual Master
                    </TabsTrigger>
                    <TabsTrigger
                      value="html"
                      className="h-full rounded-none px-6 text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-background data-[state=active]:text-primary transition-all"
                    >
                      ...
                      <div className="h-full flex flex-col p-6 space-y-4">
                        <div className="flex-1 relative group/source">
                          <textarea
                            readOnly
                            value={html}
                            className="w-full h-full bg-background/90 text-green-500/90 font-mono text-xs p-6 rounded-2xl border border-white/5 shadow-inner resize-none custom-scrollbar"
                          />
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <Button
                            ...
                            className="h-14 rounded-2xl bg-secondary border border-border text-primary font-black uppercase text-[10px] tracking-widest hover:bg-secondary/80"
                          >
                            {isCopiedHtml ? (
                          ...
                          <Button
                            onClick={() =>
                              handleDownload(html, "export.html", "text/html")
                            }
                            className="h-14 rounded-2xl bg-primary text-primary-foreground font-black uppercase text-[10px] tracking-widest shadow-xl shadow-primary/30"
                          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Standard GitHub Flavored Markdown support for technical
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Automatic HTML sanitization ensures your studio environment
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                100% private synthesis. Your drafting and code generation occur
                entirely in your browser memory.
              </p>
            </div>
          </div>
        </div>
      ...
      <style jsx global>{`
        .markdown-preview h1 {
          @apply text-3xl font-black mb-6 mt-2 border-b-2 border-primary/20 pb-2 uppercase tracking-tight;
        }
        .markdown-preview h2 {
          @apply text-xl font-bold mb-4 mt-8 border-l-4 border-primary pl-4 uppercase tracking-tighter;
        }
        .markdown-preview h3 {
          @apply text-lg font-bold mb-3 mt-6 text-foreground/80;
        }
        .markdown-preview h4 {
          @apply text-base font-bold mb-2 mt-4 text-foreground/60;
        }
        .markdown-preview p {
          @apply mb-5 text-[15px] leading-relaxed font-medium text-foreground/70;
        }
        .markdown-preview strong {
          @apply text-foreground font-black;
        }
        .markdown-preview em {
          @apply text-primary italic font-medium;
        }
        .markdown-preview ul {
          @apply list-disc list-inside mb-6 space-y-2 text-foreground/60;
        }
        .markdown-preview ol {
          @apply list-decimal list-inside mb-6 space-y-2 text-foreground/60;
        }
        .markdown-preview li input[type="checkbox"] {
          @apply mr-2 scale-110 accent-primary;
        }
        .markdown-preview blockquote {
          @apply border-l-4 border-primary/20 bg-primary/5 p-6 my-8 rounded-r-2xl italic font-medium text-foreground/50 leading-loose;
        }
        .markdown-preview pre {
          @apply bg-background/90 p-6 rounded-2xl mb-6 overflow-x-auto border border-white/5 shadow-2xl;
        }
        .markdown-preview code {
          @apply font-mono text-[13px] text-green-500/80;
        }
        .markdown-preview :not(pre) > code {
          @apply bg-primary/10 px-1.5 py-0.5 rounded text-[12px] text-primary font-bold border border-primary/20;
        }
        .markdown-preview hr {
          @apply border-primary/10 my-10;
        }
        .markdown-preview a {
          @apply text-primary font-bold underline underline-offset-4 decoration-primary/30 hover:decoration-primary transition-all;
        }
        .markdown-preview table {
          @apply w-full mb-8 border-collapse rounded-xl overflow-hidden;
        }
        .markdown-preview th {
          @apply bg-secondary p-4 text-left text-[11px] font-black uppercase tracking-widest border border-border;
        }
        .markdown-preview td {
          @apply p-4 text-[13px] font-medium border border-border text-foreground/60;
        }
        .markdown-preview img {
          @apply rounded-2xl shadow-xl max-w-full h-auto my-8 border border-white/10;
        }
