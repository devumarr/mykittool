  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFile) {
      ...
      toast({
        ...
        description: "Ready for volume optimization.",
      });
    }
  };
  ...
  const boostVolume = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Audio gain successfully applied.",
      });
    } catch (err: any) {
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
          Professional-grade audio amplification. Increase gain levels for MP3,
          WAV, or M4A files locally with studio-grade precision.
        </p>
      </div>
                ...
                <div className="space-y-10 animate-in zoom-in duration-500">
                  <div className="space-y-6">
                    <div className="flex justify-between items-center">
                      <Label className="text-[10px] font-black text-foreground/50 uppercase tracking-[0.2em]">
                        Gain Intensity Matrix
                      </Label>
                      <span className="text-sm font-headline font-black text-primary uppercase">
                        {(gain * 100).toFixed(0)}% Boost
                      </span>
                    </div>
                    <Slider
                      value={[gain]}
                  ...
                  <div className="p-4 rounded-2xl bg-yellow-500/5 border border-yellow-500/10 flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      <p className="text-[9px] font-black text-yellow-600/70 uppercase tracking-widest">
                        Digital Clipping Advisory
                      </p>
                      <p className="text-[9px] text-foreground/40 leading-relaxed font-medium">
                        High gain levels (&gt;2.0x) may cause digital distortion
                        if the source audio is already normalized. Use moderate
                        settings for peak fidelity.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {boostedUrl && (
                  <div className="space-y-8 w-full animate-in zoom-in duration-500">
                    ...
                    >
                      <a
                        href={boostedUrl}
                        download={`${file?.name.split(".")[0] || "master"}_boosted.mp3`}
                      >
              ...
              <div className="p-6 rounded-[2rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                    Audio processing occurs entirely on your device using
