...
export default function LetterArtPage() {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        toast({
          ...
          description: "Ready for letter-art synthesis.",
        });
      };
  ...
  const generateLetterArt = useCallback(() => {
    ...
    img.onload = () => {
      ...
      toast({
        title: "Art Synthesis Complete",
        description: "Image converted to custom character matrix.",
      });
    };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
          Convert photographs into artistic character matrices using custom
          letter sets. Perfect for brand-specific ASCII art and unique textual
          visuals.
        </p>
      </div>
            ...
            <CardContent className="pt-10 space-y-10">
              ...
              <div className="space-y-4">
                ...
                <p className="text-[9px] text-foreground/30 font-bold uppercase tracking-widest leading-relaxed">
                  Tip: Characters at the start will be used for brighter pixels.
                  Leave empty for default ramp.
                </p>
              </div>
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2">
              <h4 className="text-[11px] font-black text-primary uppercase tracking-widest">
                Character Mapping Intelligence
              </h4>
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Our engine divides the 0-255 grayscale spectrum by the number of
                characters in your set, ensuring a balanced distribution of
                visual weight.
              </p>
            </div>
          </div>
            ...
            <CardContent className="pt-10 space-y-8">
              <div className="relative group/output">
                <textarea
                  ...
                  className="w-full min-h-[500px] bg-white dark:bg-background border-border text-foreground font-mono rounded-[2.5rem] p-8 text-[8px] leading-[1.0] resize-none shadow-inner custom-scrollbar transition-all overflow-auto whitespace-pre"
                />
                {!output && (
              ...
              <div className="p-6 rounded-2xl bg-secondary border border-border flex items-start gap-4 group">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                    For accurate visual representation, view output in a
                    fixed-width font (e.g. Courier, Consolas) with "Line
                    Wrapping" disabled.
                  </p>
                </div>
              </div>
