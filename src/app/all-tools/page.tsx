...
const TOOLS: Tool[] = [
  // AI Tools
  {
    ...
    category: "AI",
    icon: MessageSquare,
    keywords: ["artificial intelligence", "conversation", "bot", "chat"],
  },
  {
    ...
    category: "AI",
    icon: User,
    keywords: ["cv", "job application", "career", "resume"],
  },
  {
    ...
    category: "AI",
    icon: Mail,
    keywords: ["compose", "mail", "message", "email"],
  },
  {
    ...
    category: "AI",
    icon: Code2,
    keywords: ["programming", "scripting", "develop", "code"],
  },
  {
    ...
    category: "AI",
    icon: Sparkles,
    keywords: ["art", "drawing", "dalle", "image", "img", "photo"],
  },
  {
    href: "/speech-to-text",
    ...
    category: "AI",
    icon: Mic,
    keywords: ["transcribe", "voice typing"],
  },
  {
    href: "/text-to-speech",
  ...
  },
  {
    ...
    category: "AI",
    icon: Wand2,
    keywords: ["upscale", "fix", "restore", "image", "photo", "jpg", "png"],
  },
  {
    ...
    category: "AI",
    icon: Music,
    keywords: ["music", "acapella", "karaoke", "audio"],
  },
  ...
  // Image Tools
  {
    ...
    desc: "Resize any image to 1200×630, 1080p, or custom sizes instantly.",
    category: "Image",
    icon: Maximize2,
    keywords: ["resize", "convert", "png", "jpg", "webp"],
  },
  {
    href: "/single",
    title: "Single Studio",
  ...
  },
  {
    ...
    category: "Image",
    icon: Eraser,
    keywords: ["remove bg", "transparent", "png", "image", "photo"],
  },
  {
    href: "/image-to-link",
    title: "Image to Link",
    ...
    category: "Image",
    icon: Globe,
    keywords: ["hosting", "share", "imgur", "image", "photo"],
  },
  {
    ...
    category: "Image",
    icon: EyeOff,
    keywords: ["censor", "privacy", "redact", "image", "photo"],
  },
  {
    href: "/image-to-webp",
    title: "Image to WebP",
    ...
    category: "Image",
    icon: FileImage,
    keywords: ["converter", "webp", "image", "photo"],
  },
  {
    href: "/images-to-gif",
    title: "Images to GIF",
    ...
    category: "Image",
    icon: Film,
    keywords: ["gif maker", "animation", "image", "photo"],
  },
  {
    ...
    category: "Image",
    icon: Stamp,
    keywords: ["logo", "copyright", "image", "photo"],
  },
  {
    ...
    category: "Image",
    icon: Frame,
    keywords: ["photo frame", "border", "image"],
  },
  {
  ...
  },
  {
    ...
    category: "Image",
    icon: Smartphone,
    keywords: ["profile picture", "image", "photo"],
  },
  {
    ...
    category: "Image",
    icon: MonitorPlay,
    keywords: ["youtube", "thumbnail", "image", "photo"],
  },
  {
    ...
    category: "Image",
    icon: Tv,
    keywords: ["youtube", "banner", "image", "photo"],
  },
  {
    href: "/collage-maker",
    ...
    category: "Image",
    icon: LayoutGrid,
    keywords: ["photo collage", "grid", "image"],
  },
  {
    ...
    category: "Image",
    icon: Box,
    keywords: ["website icon", "image", "photo"],
  },
  {
    ...
    category: "Image",
    icon: ShieldCheck,
    keywords: ["exif", "gps", "privacy", "image", "photo"],
  },
  {
    href: "/color-picker",
    title: "Color Picker",
    ...
    category: "Image",
    icon: Pipette,
    keywords: ["hex", "rgb", "image", "photo"],
  },
  {
    href: "/rgb-picker",
    title: "RGB Picker",
    desc: "Advanced chromatic engineering and color space translation.",
    category: "Image",
    icon: Palette,
    keywords: ["rgb", "hsl", "color", "hex"],
  },
  {
    ...
    category: "Image",
    icon: RefreshCcw,
    keywords: ["jpg", "png", "jpeg", "webp", "image", "photo"],
  },
  {
    href: "/image-resizer",
    title: "Image Resizer",
    ...
    category: "Image",
    icon: Maximize,
    keywords: ["resize", "scale", "image", "photo"],
  },
  {
    ...
    category: "Image",
    icon: Minimize,
    keywords: ["compress", "shrink", "image", "photo", "jpg", "png"],
  },
  {
    href: "/photo-editor",
    title: "Photo Studio",
    ...
    category: "Image",
    icon: Palette,
    keywords: ["edit", "filters", "image", "photo"],
  },
  {
    href: "/letter-art",
    title: "Letter Art",
    ...
    category: "Image",
    icon: Type,
    keywords: ["ascii art", "text art", "image"],
  },
  {
    href: "/dot-art",
  ...
  },
  {
    ...
    category: "Image",
    icon: Search,
    keywords: ["transparent", "image", "png"],
  },
  {
    href: "/icon-studio",
    title: "Icon Studio",
  ...
  },
  {
    ...
    category: "Image",
    icon: MousePointer2,
    keywords: ["cursor", ".cur", "image"],
  },
  {
    href: "/image-gallery",
    title: "Image Gallery",
    desc: "Extract high-res visuals from global scientific and art registries.",
    category: "Image",
    icon: ImageIcon,
  ...
  },
  {
    href: "/exif-viewer",
    title: "EXIF Viewer",
    desc: "Clinical inspection of hidden image headers and GPS data.",
    category: "Image",
    icon: CameraIcon,
    keywords: ["exif", "metadata", "gps", "photo"],
  },
  {
    href: "/image-url-downloader",
    title: "Image URL Downloader",
    desc: "Direct image extraction from web and social nodes.",
    category: "Image",
    icon: Download,
    keywords: ["download", "url", "image"],
  },
  ...
  // File Tools
  {
    ...
    category: "File",
    icon: RotateCcw,
    keywords: ["video", "reverse"],
  },
  {
    href: "/temp-upload",
    title: "Temp Upload",
    desc: "Upload files with expiry reminders.",
    category: "File",
    icon: CloudUpload,
    keywords: ["temporary storage", "file sharing"],
  },
  {
    href: "/site-backup-cloner",
    title: "Site Backup Cloner",
    desc: "Download public frontend assets into a local ZIP backup.",
    category: "File",
    icon: FileArchive,
    keywords: ["website backup", "clone"],
  },
  {
    ...
    category: "File",
    icon: Database,
    keywords: ["telegram", "file hosting"],
  },
  {
    href: "/html-to-url",
    title: "HTML to URL",
  ...
  },
  {
    href: "/rename-file",
    title: "Rename File",
    desc: "Rename any file and download with the new name.",
    category: "File",
    icon: FileEdit,
  ...
  },
  {
    ...
    category: "File",
    icon: Unlock,
    keywords: ["pdf password remover", "unlock pdf", "pdf"],
  },
  {
    ...
    category: "File",
    icon: Lock,
    keywords: ["protect pdf", "lock pdf", "pdf"],
  },
  {
    href: "/text-to-pdf",
    title: "Text to PDF",
    ...
    category: "File",
    icon: FileText,
    keywords: ["txt to pdf", "document", "pdf"],
  },
  {
    href: "/word-to-pdf",
    title: "Word to PDF",
  ...
  },
  {
    ...
    category: "File",
    icon: FileImage,
    keywords: ["pdf to png", "pdf to jpg", "pdf", "image"],
  },
  {
    href: "/pdf-splitter",
    title: "PDF Splitter",
  ...
  },
  {
    ...
    category: "File",
    icon: Archive,
    keywords: ["compress pdf", "shrink pdf", "pdf"],
  },
  {
    href: "/pdf-merger",
    title: "PDF Merger",
    ...
    category: "File",
    icon: Layers,
    keywords: ["merge pdf", "combine pdf", "pdf"],
  },
  {
    href: "/pdf-rotator",
    title: "PDF Rotator",
    desc: "Clinical orientation management for PDF documents.",
    category: "File",
    icon: RotateCcw,
  ...
  },
  {
    ...
    category: "File",
    icon: FileUp,
    keywords: ["image", "pdf", "png", "jpg"],
  },
  {
    href: "/file-compressor",
    title: "File Compressor",
    desc: "Browser-side size reduction for visual and digital assets.",
    category: "File",
    icon: FileArchive,
  ...
  },
  {
    ...
    category: "File",
    icon: FileDown,
    keywords: ["jpg to pdf", "png to pdf", "images to pdf", "pdf"],
  },
  {
    href: "/video-to-audio",
    title: "Video to MP3",
    ...
    category: "File",
    icon: Music,
    keywords: ["video to mp3", "extract audio"],
  },
  {
    href: "/video-to-gif",
    title: "Video to GIF",
  ...
  },
  {
    ...
    category: "File",
    icon: ListMusic,
    keywords: ["merge audio", "combine audio"],
  },
  {
    href: "/audio-booster",
    ...
    category: "File",
    icon: Volume2,
    keywords: ["increase volume", "amplify"],
  },
  {
    ...
    category: "File",
    icon: Hammer,
    keywords: ["website recovery", "html"],
  },
  {
    href: "/file-downloader",
    title: "Direct File Downloader",
    desc: "Browser-side extraction from direct URLs.",
    category: "File",
    icon: Download,
  ...
  },
  {
    ...
    category: "Other",
    icon: MessageSquare,
    keywords: ["whatsapp", "link generator"],
  },
  {
    href: "/all-tools",
    title: "The ToolBox",
    desc: "Complete registry of all professional studio units.",
    category: "Other",
    icon: LayoutGrid,
    keywords: ["all tools", "directory"],
  },
  {
    href: "/all-units-converter",
    title: "All Units Converter",
    desc: "Convert Length, Weight, Temp, and more.",
    category: "Other",
    icon: Activity,
  ...
  },
  {
    ...
    category: "Other",
    icon: Search,
    keywords: ["social media", "username"],
  },
  {
    href: "/domain-whois",
    title: "Domain Whois",
  ...
  },
  {
    ...
    category: "Other",
    icon: Mail,
    keywords: ["disposable email", "temp email"],
  },
  {
    href: "/gmail-alias",
    title: "Gmail Alias Generator",
    desc: "Create unlimited Gmail aliases using Dot Trick & Plus Addressing.",
    category: "Other",
    icon: Mail,
    keywords: ["gmail", "alias"],
  },
  {
    ...
    category: "Other",
    icon: ShieldAlert,
    keywords: ["phishing", "link checker"],
  },
  {
    href: "/dns-lookup",
    title: "DNS Lookup",
  ...
  },
  {
    ...
    category: "Other",
    icon: ShieldAlert,
    keywords: ["password checker", "security"],
  },
  {
    ...
    category: "Other",
    icon: ShieldCheck,
    keywords: ["website security", "trust"],
  },
  {
    href: "/github-user",
    title: "GitHub Finder",
  ...
  },
  {
    ...
    category: "Other",
    icon: Code2,
    keywords: ["programming", "learn to code"],
  },
  {
    href: "/free-games",
    title: "Free Games",
  ...
  },
  {
    ...
    category: "Other",
    icon: Lightbulb,
    keywords: ["random facts", "knowledge"],
  },
  {
    href: "/pets",
    title: "Pet Studio",
  ...
  },
  {
    ...
    category: "Other",
    icon: Globe,
    keywords: ["country data", "geography"],
  },
  {
    href: "/crypto-prices",
    title: "Crypto Prices",
  ...
  },
  {
    ...
    category: "Other",
    icon: Smartphone,
    keywords: ["ip address", "geolocation"],
  },
  {
    href: "/keyboard-test",
    title: "Keyboard Test",
  ...
  },
  {
    ...
    category: "Other",
    icon: Maximize2,
    keywords: ["image enlarger", "photo", "image"],
  },
  {
    href: "/wps-sheets",
    title: "WPS Sheets",
  ...
  },
  {
    ...
    category: "Other",
    icon: UserCircle,
    keywords: ["instagram bio", "tiktok bio"],
  },
  {
    href: "/bmi-calculator",
  ...
  },
  {
    ...
    category: "Other",
    icon: Trophy,
    keywords: ["random wheel", "giveaway"],
  },
  {
    href: "/tax-calculator",
  ...
  },
  {
    ...
    category: "Other",
    icon: Lock,
    keywords: ["steganography", "secret message", "image", "photo"],
  },
  {
    ...
    category: "Other",
    icon: Wifi,
    keywords: ["wifi password", "qr code"],
  },
  {
    href: "/bulk",
  ...
  },
  {
    ...
    category: "Other",
    icon: Braces,
    keywords: ["json beautifier", "json validator"],
  },
  {
    href: "/regex-tester",
  ...
  },
  {
    ...
    category: "Other",
    icon: Hash,
    keywords: ["hashtag generator"],
  },
  {
    href: "/word-counter",
    title: "Word Counter",
    desc: "Calculate density, character volume, and precise reading time.",
    category: "Other",
    icon: Calculator,
    keywords: ["text analysis", "counter"],
  },
  {
    href: "/markdown-preview",
    title: "Markdown Preview",
    desc: "Professional real-time Markdown synthesis and HTML output.",
    category: "Other",
    icon: FileEdit,
    keywords: ["editor", "preview", "md"],
  },
  {
    href: "/repeater",
    title: "Text Repeater",
    desc: "Instantly multiply text or emojis for creative design.",
    category: "Other",
    icon: RefreshCcw,
    keywords: ["loop", "multiplier"],
  },
  {
    href: "/code-converter",
    title: "Code Converter",
    desc: "Professional AOB utility for pattern conversion.",
    category: "Other",
    icon: Code2,
    keywords: ["hex", "aob", "c++", "python"],
  },
  {
    href: "/dictionary",
    title: "Dictionary Studio",
    desc: "Linguistic analysis, definitions, and audio pronunciations.",
    category: "Other",
    icon: Book,
    keywords: ["words", "meaning"],
  },
  {
    href: "/age-calculator",
    title: "Age Calculator",
    desc: "Professional chronological analysis matrix.",
    category: "Other",
    icon: Calendar,
    keywords: ["age", "time", "birthday"],
  },
  {
    href: "/code-preview",
    title: "Code Preview Lab",
    desc: "Sandboxed environment for web project inspection.",
    category: "Other",
    icon: Monitor,
    keywords: ["web", "dev", "html"],
  },
  {
    href: "/media-downloader",
    title: "Media Downloader",
    desc: "High-performance media discovery and extraction.",
    category: "Other",
    icon: MonitorPlay,
...
function AllToolsPageContent() {
  ...
  const { displayedTools, didYouMean, foundCount } = useMemo(() => {
    ...
    let categoryFilteredTools = TOOLS.filter(
    ...
    const exactMatches = categoryFilteredTools.filter(
      (tool) =>
    ...
    if (exactMatches.length > 0) {
      return {
        displayedTools: exactMatches,
        didYouMean: null,
        foundCount: exactMatches.length,
      };
    }

    const allToolsWithDistance = categoryFilteredTools
      .map((tool) => ({
        ...tool,
    ...
    const didYouMeanSuggestion =
      bestMatch && bestMatch.distance > 0 && bestMatch.distance <= 3
        ? bestMatch.title
        : null;
