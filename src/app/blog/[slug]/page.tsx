...
const POSTS: Record<string, BlogPost> = {
  "remove-background-free": {
    ...
    subtitle:
      "Isolate subjects instantly with high-fidelity neural extraction.",
    intro:
      "Removing backgrounds is essential for creating professional product photos, transparent logos, and creative composites. Our studio uses advanced local processing to ensure your images are sanitized without losing quality.",
    category: "Image",
    icon: Eraser,
  ...
  "merge-pdf-online": {
    ...
    intro:
      "Unified documentation is key for professional reporting and archival. Our merger utility allows you to organize multiple PDF files into a single, cohesive document with zero-latency local logic.",
    category: "PDF",
    icon: Layers,
    toolUrl: "/pdf-merger",
    toolLabel: "Merge",
  ...
  "compress-pdf-online": {
    ...
    intro:
      "Large PDF files can be difficult to share or upload. Our compression studio optimizes your document volume by cleaning internal metadata and compacting the file structure locally.",
    category: "PDF",
    icon: Archive,
  ...
  "image-to-pdf": {
    ...
    intro:
      "Transforming photos into a document format is perfect for portfolios, reports, and digital books. This tool wraps your images into a high-resolution PDF while maintaining original visual fidelity.",
    category: "PDF",
    icon: FileText,
  ...
  "ai-resume-free": {
    ...
    subtitle:
      "Forging career identities via high-entropy linguistic synthesis.",
    intro:
      "A well-structured resume is the foundation of professional growth. Our AI-driven builder uses impactful action verbs and achieves consistent formatting to pass automated screening nodes.",
    category: "AI",
    icon: User,
  ...
  "ai-email-writer-guide": {
    ...
    intro:
      "Writing clear, concise emails can take time. Our AI email studio drafts professional messages for any purpose, from job applications to client follow-ups, with precision tone control.",
    category: "AI",
    icon: Mail,
  ...
  if (!post) {
    return (
      <div className="container mx-auto px-6 py-32 text-center bg-[#0a0a0c] min-h-screen">
        <h1 className="text-2xl font-black text-white/40 uppercase">
          Protocol Not Found
        </h1>
        <Button
          asChild
          className="mt-8 h-12 px-8 rounded-xl bg-primary text-white"
        >
        ...
        <div className="mb-16 animate-reveal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start mb-32">
            <div className="md:col-span-8 space-y-12">
              ...
              <div className="space-y-8">
                <h3 className="text-lg font-black text-white uppercase tracking-widest flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary" /> Execution
                  Protocol
                </h3>
                <div className="space-y-6">
                  {post.steps.map((step, i) => (
                    <div key={i} className="flex gap-6 group">
                      ...
                      <p className="text-[15px] sm:text-lg text-white/60 leading-relaxed pt-1">
                        {step}
                      </p>
                    </div>
                  ))}
              ...
              <div className="pt-10">
                <Button
                  asChild
                  className="h-20 w-full bg-primary text-white font-black text-lg uppercase tracking-widest rounded-3xl shadow-xl shadow-primary/30 active:scale-95 transition-all"
                >
            ...
            <aside className="md:col-span-4 space-y-8">
              <Card className="glass-card p-8 border-white/10 rounded-[2.5rem] bg-background">
                <div className="space-y-6">
                  ...
                  <ul className="space-y-4">
                    {post.tips.map((tip, i) => (
                      <li key={i} className="flex items-start gap-3">
                        ...
                        <span className="text-[10px] font-bold text-white/40 leading-relaxed uppercase tracking-tighter">
                          {tip}
                        </span>
                      </li>
                    ))}
              ...
              <div className="p-8 rounded-[2.5rem] bg-secondary/50 border border-white/5 flex flex-col gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-[10px] font-black uppercase text-white leading-none">
                      Privacy Safe
                    </p>
                  ...
                  >
                    <Card className="glass-card p-8 rounded-[2.5rem] bg-white/[0.01] border-white/5 hover:border-primary/30 transition-all flex flex-col h-full gap-6">
                      ...
                      <div className="space-y-2">
                        <h4 className="text-lg font-headline font-black text-white uppercase leading-tight group-hover:text-primary transition-colors">
                          {rPost.h1}
                        </h4>
                        <p className="text-[10px] text-white/30 font-medium uppercase tracking-widest line-clamp-2">
                          {rPost.subtitle}
                        </p>
                      </div>
                    </Card>
