...
export default function RenameFilePage() {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFile) {
      ...
      toast({
        ...
        description: "Identity matrix ready for re-labeling.",
      });
    }
  };
  ...
  const handleDownload = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Renamed & Saved",
        description: `"${finalName}" pushed to local storage.`,
      });
    }, 100);
  };
    ...
    <div className="container mx-auto px-4 sm:px-6 py-12 md:py-20 max-w-7xl">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl leading-relaxed overflow-wrap-anywhere">
          Professional browser-side file re-labeling. Modify filenames and
          extensions with zero quality loss and absolute privacy. 100% local
          synthesis.
        </p>
      </div>
                  ...
                  {file ? (
                    <div className="text-center p-8 space-y-4 min-w-0 w-full">
                      ...
                      <div className="space-y-1 min-w-0">
                        <p className="text-xs font-black uppercase text-foreground truncate max-w-full px-4">
                          {file.name}
                        </p>
                        <p className="text-[10px] font-bold text-foreground/30 uppercase tracking-widest">
                          {fileInfo?.size} detected
                        </p>
                      </div>
                    </div>
                  ) : (
                    <>
                      ...
                      <p className="text-[10px] font-black uppercase text-foreground/40 tracking-widest group-hover:text-primary transition-colors text-center px-6 leading-relaxed">
                        Drop any asset or click to browse
                        <br />
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-6 rounded-[2rem] bg-secondary/50 border border-border flex items-center justify-between group hover:border-primary/20 transition-all">
                      <div className="space-y-1 min-w-0 pr-4">
                        ...
                        <p className="text-[9px] text-foreground/30 font-medium uppercase truncate">
                      ...
                      <Switch
                        ...
                        onCheckedChange={setKeepExtension}
                        className="shrink-0"
                      />
                    </div>
                  </div>
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2 min-w-0">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase overflow-wrap-anywhere">
                The studio performs re-labeling entirely within your browser
                session. Binary data is never transmitted to our servers,
                maintaining a 100% secure local workflow.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 space-y-8 animate-in fade-in slide-in-from-right-6 duration-1000 stagger-2">
                ...
                <div className="space-y-10 animate-in zoom-in duration-500 min-w-0">
                  <div className="p-6 sm:p-10 rounded-[3rem] bg-secondary/50 border border-border flex flex-col items-center justify-center gap-8 shadow-inner relative overflow-hidden group/final">
                    ...
                    <div className="text-center space-y-4 w-full min-w-0">
                      ...
                      <div className="bg-white dark:bg-background p-4 sm:p-6 rounded-2xl border border-border shadow-inner min-w-0">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group transition-all hover:bg-secondary/80">
                      ...
                      <div className="space-y-1 min-w-0">
                        ...
                        <p className="text-[10px] text-foreground/40 font-medium leading-relaxed overflow-wrap-anywhere">
                          System creates a direct memory pointer to the original
                          bytes with the new label.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group transition-all hover:bg-secondary/80">
                      ...
                      <div className="space-y-1 min-w-0">
                        ...
                        <p className="text-[10px] text-foreground/40 font-medium leading-relaxed overflow-wrap-anywhere">
                          Original file creation dates and internal headers are
          ...
          <div className="p-8 rounded-[3rem] bg-secondary border border-border flex items-start gap-6 group hover:bg-secondary/80 transition-all duration-500 shadow-lg">
            ...
            <div className="space-y-2 min-w-0">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase overflow-wrap-anywhere">
                Our re-labeling engine bypasses the operating system's standard
                file dialog constraints, allowing for clinical precision in
                filename production before local storage commitment.
              </p>
            </div>
          </div>
        </div>
