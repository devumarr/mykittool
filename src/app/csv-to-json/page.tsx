...
export default function CsvToJsonPage() {
  ...
  const jsonOutput = useMemo(() => {
    ...
    try {
      ...
      setError(
        "Matrix Alignment Error: Malformed CSV structure or inconsistent delimiters.",
      );
      return "";
    }
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        toast({
          title: "Matrix Injected",
          description: "CSV data loaded into studio.",
        });
      };
  ...
  const handleCopy = () => {
    if (jsonOutput) {
      ...
      toast({
        title: "JSON Copied",
        description: "Data matrix saved to clipboard.",
      });
  ...
  const handleDownload = () => {
    ...
    toast({
      ...
      description: "JSON master saved to device.",
    });
  };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20 max-w-7xl">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl leading-relaxed">
          Professional data translation matrix. Convert legacy CSV structures
          into optimized JSON arrays with header mapping and auto-type
          identification.
        </p>
      </div>
          ...
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative group min-h-[600px] flex flex-col">
            ...
            <CardHeader className="py-8 border-b border-border bg-secondary/30">
              <div className="flex items-center justify-between">
                ...
                {jsonOutput && (
                  <div className="px-2 py-0.5 rounded bg-primary text-white text-[8px] font-black uppercase tracking-widest shadow-lg shadow-primary/20">
                    Master Ready
                  </div>
                )}
              </div>
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/60 leading-relaxed font-medium">
                      Automatic recognition of Boolean and Numeric values within
                      the linguistic stream.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/60 leading-relaxed font-medium">
                      Translation occurs 100% in local browser memory. Hardware
