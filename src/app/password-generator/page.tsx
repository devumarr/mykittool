...
export default function PasswordGeneratorPage() {
  ...
  const generatePassword = useCallback(() => {
    ...
    if (charset === "") {
      toast({
        ...
        description: "Select at least one character set.",
      });
      return;
    }
  ...
  const getStrength = () => {
    ...
    if (score < 40)
      return { label: "Weak", color: "bg-destructive", percent: 30 };
    if (score < 70)
      return { label: "Medium", color: "bg-yellow-500", percent: 60 };
    if (score < 90)
      return { label: "Strong", color: "bg-primary", percent: 90 };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
          Professional entropy generation. Synthesize cryptographically-secure
          passwords with precision character protocols locally in your browser.
        </p>
      </div>
            ...
            <CardContent className="pt-10 space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={proto.id}
                    className="flex items-center justify-between p-5 rounded-2xl bg-secondary border border-border group/proto hover:border-primary/20 transition-all"
                  >
                    <Label
                      htmlFor={proto.id}
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                ...
                for cryptographic-grade randomness. Synthesis occurs entirely in
                your browser memory for absolute security.
              </p>
            </div>
          </div>
        </div>
          ...
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative group min-h-[400px]">
            ...
            <CardContent className="pt-10 space-y-8">
              <div className="relative group/output">
                <div
                  className={cn(
                    "min-h-[120px] bg-white dark:bg-background border border-border rounded-[2rem] p-8 flex items-center justify-center text-center shadow-inner transition-all",
              ...
              {password && (
                <div className="space-y-4 px-2">
                  <div className="flex justify-between items-center">
                    <Label className="text-[9px] font-black text-foreground/30 uppercase tracking-[0.2em]">
                      Entropy Strength
                    </Label>
                    <span
                      className={cn(
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                      Password is generated immediately upon protocol change.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                      Your data never leaves your machine. 100% private.
                    </p>
                  </div>
                </div>
              </div>
