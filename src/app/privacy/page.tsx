...
export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto px-6 py-20 max-w-4xl">
      ...
      <div className="glass-card p-10 rounded-[3rem] border-border animate-reveal stagger-3 text-center relative overflow-hidden bg-background">
        ...
        <p className="text-sm text-foreground/50 leading-relaxed font-medium max-w-xl mx-auto uppercase tracking-widest relative z-10">
          ...
          We prioritize local-first data integrity for all studio units.
        </p>
      </div>
    </div>
  );
