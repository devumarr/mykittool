        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-foreground/40 text-sm md:text-base font-medium mt-2 max-w-2xl leading-relaxed">
              Simple and professional tax utility. Calculate extra percentage or
              reverse-lookup original prices instantly.
            </p>
          </div>
          ...
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative group">
            <CardHeader className="pb-8 border-b border-border bg-secondary/30">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.3em] flex items-center gap-4 text-foreground">
                <Calculator className="w-5 h-5 text-primary" /> Preview
              </CardTitle>
            </CardHeader>
            <CardContent className="pt-10 space-y-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative group/t1">
                    <Input
                      ...
                      className="h-14 bg-secondary border-border rounded-xl text-lg font-bold text-center pr-10"
                    />
              ...
              <div className="pt-2">
                <Button
                  onClick={handleCopy}
                  disabled={!amount}
                  className="w-full h-14 bg-white text-black font-black rounded-xl uppercase tracking-widest text-[10px] shadow-xl"
                >
                  {isCopied ? (
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase">
                {mode === "add"
                  ? "Add tax = Extra % on top of your amount."
                  : "Included = % already inside the amount."}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 space-y-6 animate-in fade-in slide-in-from-right-6 duration-1000 stagger-2">
          <div className="grid grid-cols-1 gap-6">
            {[
              ...
              {
                label: "Without Tax (Net)",
                val: results.withoutTax,
                icon: Wallet,
              ...
              <Card
                key={res.label}
                className="glass-card border-border shadow-xl hover:border-primary/20 transition-all group/res"
              >
                <CardContent className="p-10 flex items-center justify-between gap-6">
                  <div className="flex items-center gap-6">
                    <div
                      className={cn(
                        "w-14 h-14 rounded-2xl bg-secondary flex items-center justify-center border border-border shadow-inner transition-transform group-hover/res:scale-110",
                        res.color,
                      )}
                    >
                    ...
                    <div className="space-y-1">
                      ...
                      <h3
                        className={cn(
                          "text-3xl sm:text-4xl font-headline font-black truncate leading-none",
                          res.color,
                        )}
                      >
                        {formatPKR(res.val)}
                  ...
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(res.val.toFixed(2));
          ...
          <div className="p-8 rounded-[3rem] bg-secondary border border-border flex items-start gap-6 group hover:bg-secondary/80 transition-all shadow-lg">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase">
                Fiscal logic operates 100% locally in your browser memory. Data
                is never transmitted to cloud registries, ensuring absolute
                privacy.
              </p>
            </div>
          </div>
