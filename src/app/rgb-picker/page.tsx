...
export default function RgbPickerPage() {
  ...
  const handleCopy = (text: string, label: string) => {
    ...
    setHistory((prev) =>
      [color.hex, ...prev.filter((c) => c !== color.hex)].slice(0, 8),
    );
  };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
          Professional chromatic engineering utility. Mix, convert, and extract
          precision values across HEX, RGB, HSL, HSV, and CMYK color spaces.
        </p>
      </div>
            ...
            <CardContent className="pt-10 space-y-12">
              ...
              <div className="flex flex-col sm:flex-row gap-8 items-center">
                ...
                >
                  ...
                  />
                  <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover/swatch:opacity-100 transition-opacity bg-background backdrop-blur-[2px] pointer-events-none">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={channel.key} className="space-y-2">
                        <Label className="text-[9px] font-black text-foreground/30 uppercase tracking-widest ml-1">
                          {channel.label}
                        </Label>
                        <Input
                          type="number"
                  ...
                  <div key={adj.key} className="space-y-4">
                    <div className="flex justify-between text-[10px] font-black uppercase tracking-widest text-foreground/50">
                      ...
                      <span className="font-mono text-primary">
                        {color[adj.key as keyof ColorState] as number}
                      </span>
                    </div>
                    <Slider
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Our engine uses high-precision matrix math for color space
                translation. Processing is 100% local, ensuring consistent
                profile generation for both web and print production.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="p-8 rounded-[2.5rem] bg-secondary border border-border space-y-6 relative overflow-hidden">
                ...
                <div className="grid grid-cols-4 gap-4">
                  {[
                    ...
                    { l: "K", v: color.k, c: "bg-background" },
                  ].map((chan) => (
                    <div key={chan.l} className="text-center space-y-2">
                      <div
                        className={cn(
                          "w-full aspect-square rounded-lg shadow-inner ring-1 ring-border",
                          chan.c,
                        )}
                      />
                      <p className="text-[9px] font-black text-foreground/40">
                        {chan.l}
                      </p>
              ...
              <div className="p-6 rounded-2xl bg-secondary border border-border flex items-start gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                    All converted values are rounded to the nearest integer for
                    CSS and hardware compatibility.
                  </p>
                </div>
              </div>
            </CardContent>
