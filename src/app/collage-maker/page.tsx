...
export default function CollageMakerPage() {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (images.length + files.length > 4) {
      toast({
        ...
        description: "Standard collage matrix supports up to 4 images.",
      });
      return;
    }
    ...
    toast({
      ...
      description: `Added ${files.length} images to the matrix.`,
    });
  ...
  const handleDownload = () => {
    ...
    link.download = `mykittool-collage-${Date.now()}.png`;
    link.href = canvasRef.current.toDataURL("image/png", 1.0);
    link.click();
    toast({
      title: "Export Success",
      description: "High-resolution collage saved.",
    });
  };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
          Combine your visual assets into professional high-resolution grids.
          100% private client-side synthesis with custom layouts and spacing
          control.
        </p>
      </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label className="text-[10px] font-black text-foreground/50 uppercase tracking-[0.2em]">
                    Source Matrix ({images.length}/4)
                  </Label>
                  <button
                    onClick={handleClear}
                    className="text-[9px] font-black text-destructive uppercase tracking-widest hover:opacity-70 transition-all"
                  >
                    Reset All
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {images.map((img) => (
                    <div
                      key={img.id}
                      className="relative aspect-square rounded-2xl overflow-hidden border border-border group/img bg-secondary shadow-inner"
                    >
                      <img
                        src={img.src}
                        alt="Thumb"
                  ...
                  {images.length < 4 && (
                    ...
                    >
                      ...
                      <span className="text-[9px] font-black uppercase text-foreground/30 group-hover/add:text-primary">
                        Add Asset
                      </span>
                    </button>
                  )}
              ...
              <div className="space-y-8 pt-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-secondary border border-border">
                    <div
                      className="w-10 h-10 rounded-lg relative overflow-hidden ring-2 ring-white"
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Collage synthesis occurs entirely on your device via the Canvas
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[11px] font-medium text-foreground/50 leading-relaxed">
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p>
                      Our engine utilizes browser-side GPU acceleration to
                      render pixel-perfect grids with zero compression artifacts
                      before export.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p>
                      Images are automatically center-cropped using "Cover"
                      logic to maintain layout integrity regardless of source
                      aspect ratios.
                    </p>
                  </div>
                </div>
