...
export default function ImageResizerPage() {
    ...
    if (file) {
      if (file.size > 15 * 1024 * 1024) {
        toast({
          ...
          description: "Files over 15MB may impact browser performance.",
        });
      }
      ...
      reader.onloadend = () => {
        ...
        img.onload = () => {
          ...
          toast({
            ...
            description: "Dimensions extracted for studio production.",
          });
        };
        img.src = result;
      };
  ...
  const applyPreset = (dim: number) => {
    ...
    toast({
      ...
      description: `Dimensions scaled to ${dim}px constraint.`,
    });
  };
    ...
    setTimeout(() => {
      ...
      img.onload = () => {
        ...
        toast({
          ...
          description: "Asset transformed to target dimensions.",
        });
      };
    }, 100);
    ...
    <div className="container mx-auto px-6 py-12 md:py-20">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl">
          Professional browser-side scaling engine. Modify pixel dimensions with
          precision aspect ratio control for high-fidelity production.
        </p>
      </div>
            ...
            <CardContent className="pt-10 space-y-10">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-8 relative">
                  <div className="space-y-4">
                    <Label className="text-[10px] font-bold text-foreground/30 uppercase tracking-widest ml-1">
                      Width
                    </Label>
                    <Input
                      type="number"
          ...
          <div className="p-6 rounded-[2.5rem] bg-primary/5 border border-primary/10 flex items-start gap-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-foreground/40 leading-relaxed font-medium">
                Our engine utilizes bi-linear smoothing algorithms via the
                Canvas API to ensure pixel integrity is preserved during
                  ...
                  <div className="p-6 rounded-2xl bg-secondary border border-border flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[10px] text-foreground/40 font-medium leading-relaxed">
                        Your visual is processed as a lossless PNG master at{" "}
                        {targetWidth}x{targetHeight} resolution. Original aspect
                        ratio was {aspectRatio.toFixed(2)}:1.
                      </p>
                    </div>
                  </div>
                </div>
