...
> = {
  ...
  speed: [{ from: "kmh", to: "mph", label: "Km/h to MPH" }],
  time: [{ from: "hour", to: "min", label: "Hour to Min" }],
  data: [
    { from: "gb", to: "mb", label: "GB to MB" },
    { from: "tb", to: "gb", label: "TB to GB" },
  ],
  pressure: [{ from: "bar", to: "psi", label: "Bar to PSI" }],
  energy: [{ from: "kcal", to: "kj", label: "Kcal to kJ" }],
  power: [{ from: "kw", to: "hp", label: "kW to HP" }],
  angle: [{ from: "deg", to: "rad", label: "Deg to Rad" }],
};
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="min-w-0">
            ...
            <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl leading-relaxed">
              Professional universal measurement matrix. Translate any
              linguistic or numeric unit across 12 distinct categories locally
              with 1:1 precision fidelity.
            </p>
          </div>
            ...
            <CardContent className="pt-10 space-y-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-[1fr,auto,1fr] gap-4 items-end">
                ...
                <Button
                  ...
                  size="icon"
                  onClick={handleSwap}
                  className="h-12 w-12 rounded-xl bg-background border-border hover:text-primary transition-all active:rotate-180 duration-500"
                >
              ...
              <div className="space-y-4 pt-4 border-t border-white/5">
                <Label className="text-[10px] font-black text-foreground/30 uppercase tracking-[0.2em] ml-1">
                  Precision Protocol
                </Label>
              ...
              {conversionResult === null ? (
                ...
                <div className="w-full space-y-12 animate-in zoom-in-95 duration-500">
                  <div className="text-center space-y-4">
                    <p className="text-[10px] font-black uppercase text-foreground/20 tracking-[0.6em]">
                      Validated Result
                    </p>
                  ...
                  <div className="p-8 rounded-[3rem] bg-secondary border border-border flex items-center justify-center gap-6 shadow-inner group/res relative overflow-hidden">
                    ...
                    <span className="text-xl font-headline font-black text-foreground/40">
                      {inputValue} {fromUnit}
                    </span>
                    <ArrowRight className="w-6 h-6 text-primary animate-pulse" />
                    <span className="text-xl font-headline font-black text-foreground">
                      {conversionResult.toFixed(precision)} {toUnit}
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="p-8 rounded-[3rem] bg-secondary border border-border flex items-start gap-6 group hover:bg-secondary/80 transition-all duration-500 shadow-lg">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase">
                  All conversion payloads are processed strictly in local
                  browser memory. Hardware identifiers are never transmitted or
                  logged.
                </p>
              </div>
            </div>
            <div className="p-8 rounded-[3rem] bg-secondary border border-border flex items-start gap-6 group hover:bg-secondary/80 transition-all duration-500 shadow-lg">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase">
                  Utilizing 1:1 standardized SI and Imperial multipliers to
                  ensure clinical accuracy across all scientific measurement
                  blocks.
                </p>
              </div>
            </div>
