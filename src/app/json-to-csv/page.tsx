...
export default function JsonToCsvPage() {
  ...
  const csvOutput = useMemo(() => {
    ...
    try {
      ...
      setError(
        `Matrix Parse Failure: ${err.message || "Invalid JSON structure"}`,
      );
      return "";
    }
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        toast({
          title: "JSON Matrix Injected",
          description: "Source data successfully loaded.",
        });
      };
  ...
  const handleDownload = () => {
    ...
    toast({
      ...
      description: "CSV master saved to device.",
    });
  };
    ...
    <div className="container mx-auto px-6 py-12 md:py-20 max-w-7xl">
      <div className="mb-12 animate-reveal">
        ...
        <p className="text-foreground/40 text-sm md:text-base font-medium mt-4 max-w-2xl leading-relaxed">
          High-performance data deconstruction. Convert complex JSON objects
          into flat CSV matrices with automated object flattening and clinical
          header mapping.
        </p>
      </div>
            ...
            <CardContent className="pt-10 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-border">
                <div className="space-y-4">
                  ...
                  <Select
                    value={delimiter}
                    onValueChange={(v: any) => setDelimiter(v)}
                  >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl bg-secondary/50 border border-border flex items-center justify-between group transition-all hover:border-primary/20">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[7px] text-foreground/20 font-bold uppercase tracking-tighter">
                        Deep Objects
                      </p>
                    </div>
                    <Switch
          ...
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative group min-h-[600px] flex flex-col">
            ...
            <CardHeader className="py-8 border-b border-border bg-secondary/30">
              <div className="flex items-center justify-between">
                ...
                {csvOutput && (
                  <div className="px-3 py-1 rounded-lg bg-primary text-white text-[8px] font-black uppercase tracking-widest shadow-lg shadow-primary/20">
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/60 leading-relaxed font-medium uppercase">
                      Deeply nested objects are translated to dot-separated
                      header strings for clinical data mapping.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-5 rounded-2xl bg-secondary border border-border group">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] text-foreground/60 leading-relaxed font-medium uppercase">
                      All data translation occurs 100% locally. Hardware-native
                      memory isolation ensures zero leakage.
                    </p>
                  </div>
                </div>
              </div>
