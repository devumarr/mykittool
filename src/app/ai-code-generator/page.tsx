...
export default function AiCodeGeneratorPage() {
  ...
  const handleConnectCustom = () => {
    ...
    toast({
      ...
      description: "Custom identity matrix active.",
    });
  };
  ...
  const handleGenerate = async (isImprove = false) => {
    ...
    if (!task.trim() && !isImprove) {
      toast({
        variant: "destructive",
        title: "Missing Input",
        description: "Describe your requirement to begin.",
      });
      return;
    }
      ...
      if (response.ok && data.ok) {
        ...
        if (isImprove) {
          ...
          toast({
            ...
            description: "Code matrix established.",
          });
        }
      } else {
    ...
    <div className="container mx-auto px-4 md:px-6 py-12 md:py-20 max-w-full bg-[#0a0a0c] min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <CardContent className="p-6 space-y-4">
                <div className="space-y-3">
                  <div className="space-y-1.5">
                    <Label className="text-[8px] font-black uppercase text-foreground/40">
                      API URL (Optional)
                    </Label>
                    <Input
                      value={customApi.url}
                      onChange={(e) =>
                        setCustomApi({ ...customApi, url: e.target.value })
                      }
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      value={customApi.key}
                      onChange={(e) =>
                        setCustomApi({ ...customApi, key: e.target.value })
                      }
                      placeholder="sk-..."
                      className="h-9 bg-background border-border text-[10px] font-mono"
                    />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setCustomApi({ ...customApi, model: e.target.value })
                      }
                      placeholder="Auto-detect from key"
                      className="h-9 bg-background border-border text-[10px] font-mono"
                    />
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  {isCustomConnected && (
                    <Button
                      ...
                      className="w-10 h-10 border-red-500/20 text-red-500 hover:bg-red-500/10"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder={
                      mode === "fix"
                        ? "Paste the code containing the error..."
                        : "e.g. Build a secure password hash utility in Node.js..."
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Specific frameworks, comments, error handling..."
                    className="h-24 bg-secondary/30 border-border rounded-2xl text-[10px] resize-none p-4 no-scrollbar"
                  />
                </div>
              </div>
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-3 mt-1">
                          <Badge
                            variant="outline"
                            className="text-[6px] py-0 px-2 border-primary/20 text-primary uppercase"
                          >
                            {item.language}
                          </Badge>
                          <Badge
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-2 text-foreground/10 hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100"
                        >
        ...
        <div className="lg:col-span-7 xl:col-span-8 space-y-8 animate-in fade-in slide-in-from-right-6 duration-1000">
          <Card className="glass-card border-border shadow-2xl overflow-hidden relative flex flex-col max-h-[850px] bg-background">
                  ...
                  <div className="space-y-4 animate-in slide-in-from-bottom-2 duration-500">
                    ...
                    <div className="flex gap-3">
                      <Input
                        ...
                        onKeyDown={(e) =>
                          e.key === "Enter" && handleGenerate(true)
                        }
                      />
                      <Button
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-4 border-t border-white/5">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button
                        variant="outline"
                        onClick={() => handleGenerate()}
                        className="h-16 px-10 border-white/10 bg-white/5 text-primary font-black uppercase text-[10px] tracking-widest rounded-2xl hover:bg-primary/10 transition-all"
                      >
