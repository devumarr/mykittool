    ...
    if (recognitionRef.current) {
      ...
      if (transcript.trim()) {
        ...
        toast({
          ...
          description: "Transcription saved to registry.",
        });
      }
    }
  };
  ...
  if (!isSupported) {
    return (
      <div className="container mx-auto px-6 py-20 text-center">
        <Card className="glass-card border-border shadow-2xl p-12 flex flex-col items-center gap-8 bg-background/10 rounded-[3rem]">
          ...
          <div className="space-y-4">
            ...
            <p className="text-foreground/40 font-medium leading-relaxed max-w-md mx-auto uppercase tracking-tighter">
              The Web Speech protocol is not identified in this hardware
              context. Use{" "}
              <span className="text-primary font-bold">Chrome</span> or{" "}
              <span className="text-primary font-bold">Edge</span> for
          ...
          <Button
            asChild
            variant="outline"
            className="h-14 px-10 rounded-2xl border-white/10 bg-white/5"
          >
                    ...
                    {status === "listening" ? (
                      <>
                        ...
                        <div className="space-y-1 z-10">
                          <h4 className="text-[11px] font-black uppercase text-primary tracking-[0.4em]">
                            Streaming Active
                          </h4>
                          <p className="text-[9px] text-foreground/30 font-medium uppercase">
                            Decoding linguistic signals...
                          </p>
                        </div>
                      ...
                      <>
                        ...
                        <div className="space-y-2 px-8">
                          <h4 className="text-[11px] font-black uppercase text-destructive">
                            Hardware Block
                          </h4>
                      ...
                      <>
                        ...
                        <div className="space-y-1">
                          <h4 className="text-[11px] font-black uppercase text-foreground/40">
                            Ready to listen
                          </h4>
              ...
              <div className="p-8 rounded-[3rem] bg-secondary/50 border border-border flex items-start gap-6 group hover:bg-secondary/80 transition-all duration-500 shadow-lg">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[11px] text-foreground/40 leading-relaxed font-medium uppercase">
                    Linguistic deconstruction occurs 100% in local volatile
                    memory. No audio waveforms or text strings are ever stored
                    on remote studio servers.
                  </p>
                </div>
              </div>
            </CardContent>
                ...
                <div className="w-full h-full min-h-[450px] p-0 custom-scrollbar overflow-y-auto">
                  {transcript ? (
                    <div className="text-xl sm:text-2xl font-medium text-foreground leading-relaxed">
                      ...
                      {interimTranscript && (
                        <span className="text-primary/40 italic ml-2 select-none">
                          {interimTranscript}
                        </span>
                      )}
                    </div>
              ...
              {transcript && (
                <div className="mt-8 pt-8 border-t border-white/5 space-y-6 animate-in slide-in-from-bottom-4">
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <Button
                      onClick={handleCopy}
                      className="h-14 bg-white text-black hover:bg-white/90 font-black rounded-2xl flex items-center justify-center gap-3 text-xs shadow-2xl active:scale-95 transition-all col-span-2"
                    >
                      {isCopied ? (
                    ...
                    <Button
                      ...
                      className="h-14 border-white/10 bg-white/5 text-white/40 font-black uppercase text-[9px] rounded-2xl"
                    >
                      <FileText className="w-4 h-4 mr-2" /> TXT
                    </Button>
                    <Button
                      variant="outline"
                      onClick={purgeLastLine}
                      className="h-14 border-white/10 bg-white/5 text-white/40 font-black uppercase text-[9px] rounded-2xl hover:text-primary"
                    >
                  ...
                  <div className="flex items-center justify-between px-2">
                    <p className="text-[8px] font-black text-foreground/20 uppercase tracking-[0.4em]">
                      Hardware-Native Matrix Synthesis
                    </p>
                    <div className="flex items-center gap-3 text-primary/40">
                      <Zap className="w-3.5 h-3.5" />
                      <span className="text-[8px] font-black uppercase tracking-widest">
                        {transcript.split(" ").length} Words Isolated
                      </span>
                    </div>
                  </div>
                </div>
