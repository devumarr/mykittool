...
export const HELP_REGISTRY: Record<string, HelpContent> = {
  "image-size-converter": {
    ...
    description:
      "Professional browser-side image scaling and format conversion utility.",
    steps: [
    ...
    privacy:
      "All processing occurs 100% locally in your browser memory. Imagery is never transmitted or stored.",
  },
  single: {
    title: "Single QR Studio",
    description:
      "Design premium, branded QR codes with custom logos and AI-generated backgrounds.",
    steps: [
    ...
    privacy:
      "Generation occurs entirely on your device. Only AI prompts are sent to secure cloud nodes for processing.",
  },
  "ai-chatbot": {
    title: "AI Chatbot Studio",
    description:
      "A professional linguistic synthesis environment for real-time AI collaboration.",
    steps: [
      "starta session by typing a prompt in the command input.",
    ...
    privacy:
      "Chat history is stored locally (anonymous) or in Firestore (authenticated). No biometric data is logged.",
  },
  bulk: {
    title: "Bulk Production Engine",
    description:
      "Generate large batches of high-resolution QR assets from a list of data strings.",
    steps: [
    ...
    privacy:
      "All rendering and ZIP creation happen locally in your browser memory.",
  },
  "all-units-converter": {
    title: "All Units Converter Studio",
    description:
      "Professional universal measurement matrix. Translate values across 12 distinct scientific and common measurement categories.",
    steps: [
    ...
    privacy:
      "All measurement logic operates 100% locally in your browser memory. No numeric data or conversion intent is logged or transmitted.",
  },
  "temp-mail": {
    title: "Temp Mail Studio Pro",
    description:
      "Advanced disposable email synthesis. Generate temporary identities to receive verification codes and protect your primary accounts.",
    steps: [
    ...
    privacy:
      "Emails are retrieved via anonymous proxies. No permanent record of your activity is kept.",
  },
  ocr: {
    title: "Photo to Text Studio",
    description:
      "Professional-grade Optical Character Recognition (OCR) for document extraction.",
    steps: [
    ...
    privacy:
      "Processing utilizes a dual-path hybrid model (Cloud/Local). Visual data is purged after each session.",
  },
  "logo-maker": {
    title: "Logo Text Studio",
    description:
      "Premium typographic branding architecture for logos, avatars, and social icons.",
    steps: [
